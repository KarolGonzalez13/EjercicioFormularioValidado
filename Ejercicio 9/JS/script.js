...
function recibirDatos(e){
    e.preventDefault();
    console.log("Estas en JavaScript");
    ...
    mensajeNombre.classList.add("ocultar");
        document.getElementById("nombre").classList.add("correoInput");
        xmarkErrorNombre.classList.add("ocultar");
        checkMarkNombre.classList.remover("ocultar");
        enviarDatos ++;
}
        ...
        mensajeCelular.classList.add("ocultar");
            document.getElementById("celular").classList.add("correoInput");
            xmarkErrorCelular.classList.add("ocultar");
            checkMarkCelular.classList.remover("ocultar");
            enviarDatos ++;
    }
    ...
    mensajeCorreo.classList.add("ocultar");
        document.getElementById("correo").classList.add("correoInput");
        xmarkErrorCorreo.classList.add("ocultar");
        checkMarkCorreo.classList.remover("ocultar");
        enviarDatos ++;
    }
